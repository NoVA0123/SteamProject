...
clang++ -g -gcodeview -O2 -march=native ..\code\test.cpp ..\code\csv_parser.cpp ..\code\platform_metrics.cpp ..\code\repetition_tester.cpp ..\code\combiner.cpp ..\code\data_cleaning.cpp ..\code\BPE.cpp -o test.exe
