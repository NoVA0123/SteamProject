...
clang++ -g -gcodeview -O2 -mavx2 ..\code\test.cpp ..\code\csv_parser.cpp ..\code\platform_metrics.cpp ..\code\repetition_tester.cpp ..\code\combiner.cpp ..\code\data_cleaning.cpp -o test.exe
